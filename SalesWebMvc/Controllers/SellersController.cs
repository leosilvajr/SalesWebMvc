...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Index() //Chamo o controlador
        {
        ...
        {
            var departments = await _departmentService.FindAllAsync(); //Busca do Banco de Dados, todos os departamentos
        ...
        {
            if (!ModelState.IsValid) //Obriga o usuario preencher o formulário
            {
